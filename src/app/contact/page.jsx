            ...
            <div className="container mx-auto">
                <div className="flex flex-col xl:flex-row gap-[30px]">
                    ...
                    <div className="xl:w-[54%] order-2 xl:order-none">
                        <form action="https://api.getform.io/v1/forms/8ea5fd1a-a99d-4cb2-a93c-da9d466cef61?token=89o29Ba7thqpd1bA3toZOmz7uXyhhfiQdfq37xQPQQmroqOQTPFJTQqQl2I6" method="POST" className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
